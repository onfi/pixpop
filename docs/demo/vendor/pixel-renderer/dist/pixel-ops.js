...
export function blitScaledRgba(dst, src, x, y, scale) {
...
export function drawSjisText1Bit(dst, atlas1Bit, glyphWidth, glyphHeight, bitOrder, codes, x, y, scale, color) {
    if (!Number.isInteger(scale) || scale < 1) {
        throw new PixelRendererError("E_INVALID_SCALE", `Invalid scale: ${scale}`);
    }
